...
class TestRareFactorByFixed:
    def test_init_with_int_weights(self):
        ...
        factor = RareFactorByFixed(weights, max_weight=30, is_visible=True)
    ...
    def test_init_with_decimal_weights(self):
        ...
        factor = RareFactorByFixed(weights, precision=3, max_weight=20.5, is_visible=True)
    ...
    def test_init_with_mixed_weights(self):
        ...
        factor = RareFactorByFixed(weights, precision=3, max_weight=30, is_visible=True)
